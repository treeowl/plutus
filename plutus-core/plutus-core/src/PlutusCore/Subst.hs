...
substVarA nameF t@(Var _ name) = nameF name
substVarA _     t              = pure Nothing
...
typeSubstTyNamesM tynameF ty = undefined  --case typeSubtypes . substTyVarA
...
termSubstNamesM = undefined -- transformMOf termSubterms . substVarA
